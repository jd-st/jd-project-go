...
```sh
go get -u 'github.com/jd-st/jd-project-go@v0.5.0'
```
...
func main() {
	...
	order, err := client.St00000re.Orders.New(context.TODO(), jdproject.St00000reOrderNewParams{})
	if err != nil {
		panic(err.Error())
	}
	fmt.Printf("%+v\n", order.ID)
...
client.St00000re.ListInventory(context.TODO(), ...,
	// Override the header
...
if err != nil {
	...
	panic(err.Error()) // GET "/st00000re/inventory": 400 Bad Request { ... }
}
```
...
defer cancel()
client.St00000re.ListInventory(
	ctx,
...
client.St00000re.ListInventory(context.TODO(), option.WithMaxRetries(5))
```
...
response, err := client.St00000re.ListInventory(context.TODO(), option.WithResponseInto(&response))
if err != nil {
	// handle error
}
fmt.Printf("%+v\n", response)
