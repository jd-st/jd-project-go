...
client.St00re.ListInventory(context.TODO(), ...,
	// Override the header
...
```go
_, err := client.St00re.ListInventory(context.TODO())
if err != nil {
	...
	panic(err.Error()) // GET "/st00re/inventory": 400 Bad Request { ... }
}
```
...
client.St00re.ListInventory(context.TODO(), option.WithMaxRetries(5))
```
...
response, err := client.St00re.ListInventory(context.TODO(), option.WithResponseInto(&response))
if err != nil {
	// handle error
}
fmt.Printf("%+v\n", response)
