...
- <a href="https://pkg.go.dev/github.com/jd-st/jd-project-go">jdproject</a>.<a href="https://pkg.go.dev/github.com/jd-st/jd-project-go#Petst0reListInventoryResponse">Petst0reListInventoryResponse</a>

Methods:

- <code title="get /petst0re/inventory">client.Petst0re.<a href="https://pkg.go.dev/github.com/jd-st/jd-project-go#Petst0reService.ListInventory">ListInventory</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>) (<a href="https://pkg.go.dev/github.com/jd-st/jd-project-go">jdproject</a>.<a href="https://pkg.go.dev/github.com/jd-st/jd-project-go#Petst0reListInventoryResponse">Petst0reListInventoryResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>

## Orders

Methods:

- <code title="post /petst0re/order">client.Petst0re.Orders.<a href="https://pkg.go.dev/github.com/jd-st/jd-project-go#Petst0reOrderService.New">New</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, body <a href="https://pkg.go.dev/github.com/jd-st/jd-project-go">jdproject</a>.<a href="https://pkg.go.dev/github.com/jd-st/jd-project-go#Petst0reOrderNewParams">Petst0reOrderNewParams</a>) (<a href="https://pkg.go.dev/github.com/jd-st/jd-project-go/shared">shared</a>.<a href="https://pkg.go.dev/github.com/jd-st/jd-project-go/shared#Order">Order</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
- <code title="get /petst0re/order/{orderId}">client.Petst0re.Orders.<a href="https://pkg.go.dev/github.com/jd-st/jd-project-go#Petst0reOrderService.Get">Get</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, orderID <a href="https://pkg.go.dev/builtin#int64">int64</a>) (<a href="https://pkg.go.dev/github.com/jd-st/jd-project-go/shared">shared</a>.<a href="https://pkg.go.dev/github.com/jd-st/jd-project-go/shared#Order">Order</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
- <code title="delete /petst0re/order/{orderId}">client.Petst0re.Orders.<a href="https://pkg.go.dev/github.com/jd-st/jd-project-go#Petst0reOrderService.Delete">Delete</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, orderID <a href="https://pkg.go.dev/builtin#int64">int64</a>) <a href="https://pkg.go.dev/builtin#error">error</a></code>
