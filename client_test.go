...
func TestUserAgentHeader(t *testing.T) {
	...
	client.St000re.ListInventory(context.Background())
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.St000re.ListInventory(context.Background())
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.St000re.ListInventory(cancelCtx)
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.St000re.ListInventory(deadlineCtx)
		if err == nil {
